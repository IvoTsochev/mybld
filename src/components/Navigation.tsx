...
export const Navigation = () => {
  ...
  return (
    <nav
      className={`absolute left-0 w-full z-50 flex flex-col md:flex-row justify-between items-center px-[5%] py-8 gap-4 md:gap-0 text-white font-sans ${announcementBannerData?.enabled ? "top-24" : "top-0"}`}
    >
